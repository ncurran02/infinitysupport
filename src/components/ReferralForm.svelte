<script lang="ts">
    ...
    function validate() {
        ...
        if (step === 1) {
            if (participant.name && participant.email && participant.phone && participant.dob && participant.disability) {
                next();
            } else {
                alert("Please fill out the required fields!")
            }
        } else if (step === 2) {
            if (services.accomodation || services.allied || services.community || services.support) {
                next();
            } else {
                alert("You must select one of the services!")
            }
        } else if (step === 3) {
            if (coordinator.name && coordinator.email && coordinator.phone) {
                next();
            } else {
                alert("Please fill out the required fields!")
            }
        } else if (step === 4) {
            if (plan.name && plan.email && plan.type) {
                next();
            } else {
                alert("Please fill out the required fields!")
            }
        } else if (step === 5) {
            if (ndis.ndisNumber && ndis.startDate && ndis.endDate) {
                next();
            } else {
                alert("Please fill out the required fields!")
            }
    ...
    <form bind:this={form} on:submit={submit} id="contactForm" class="flex flex-col justify-center items-center">
        ...
        <div id="participant" class="flex flex-col justify-center items-center w-full">
            <div class="gap-2 text-left m-5 w-[85%] flex flex-col">
                <label class="text-xl text-[#116089] font-semibold" for="name">Name <span class="text-error">*</span></label>
            ...
            <div class="gap-2 text-left m-5 w-[85%] flex flex-col">
                <label class="text-xl text-[#116089] font-semibold" for="email">Email <span class="text-error">*</span></label>
            ...
            <div class="gap-2 text-left m-5 w-[85%] flex flex-col">
                <label class="text-xl text-[#116089] font-semibold" for="phone">Phone <span class="text-error">*</span></label>
                <input bind:value={formData.participant.phone} class="input validator w-full" type="tel" id="phone" name="phone" placeholder="Phone" required />
            </div>
            <div class="gap-2 text-left m-5 w-[85%] flex flex-col">
                <label class="text-xl text-[#116089] font-semibold" for="dob">Date of Birth <span class="text-error">*</span></label>
                <input bind:value={formData.participant.dob} class="input validator" type="date" id="dob" name="dob" required />
            </div>
            <div class="gap-2 text-left m-5 w-[85%] flex flex-col">
                <label class="text-xl text-[#116089] font-semibold" for="disability">Primary Disability <span class="text-error">*</span></label>
            ...
            <div class="flex flex-row justify-center">
                <button on:click={validate} class="btn btn-md bg-[#6cab38] hover:bg-[#6cab38]/85 text-white w-[75%] m-5" type="button">Next</button>
            </div>
        </div>
        {:else if step === 2}
        ...
        <div id="services" class="gap-2 text-left m-5 w-[85%] flex flex-col justify-between lg:items-center items-start mx-auto">
            ...
            <div class="flex flex-row justify-center mx-auto">
                ...
                <button on:click={validate} class="btn btn-md bg-[#6cab38] hover:bg-[#6cab38]/85 text-white w-1/2 m-5" type="button">Next</button>
            </div>
        </div>
        {:else if step === 3}
        ...
        <div id="coordinator" class="flex flex-col justify-center items-center w-full">
            <div class="gap-2 text-left m-5 w-[85%] flex flex-col">
                <label class="text-xl text-[#116089] font-semibold" for="coordname">Name <span class="text-error">*</span></label>
            ...
            <div class="gap-2 text-left m-5 w-[85%] flex flex-col">
                <label class="text-xl text-[#116089] font-semibold" for="coordemail">Email <span class="text-error">*</span></label>
            ...
            <div class="gap-2 text-left m-5 w-[85%] flex flex-col">
                <label class="text-xl text-[#116089] font-semibold" for="coordphone">Phone <span class="text-error">*</span></label>
        ...
        <div id="plan" class="flex flex-col justify-center items-center w-full">
            <div class="gap-2 text-left m-5 w-[85%] flex flex-col">
                <label class="text-xl text-[#116089] font-semibold" for="planname">Name <span class="text-error">*</span></label>
            ...
            <div class="gap-2 text-left m-5 w-[85%] flex flex-col">
                <label class="text-xl text-[#116089] font-semibold" for="planemail">Email <span class="text-error">*</span></label>
            ...
            <div class="flex lg:flex-row flex-col justify-center items-center">
                <label class="text-xl text-[#116089] font-semibold" for="plantype">How is the plan managed? <span class="text-error">*</span></label>
        ...
        <div id="ndis" class="flex flex-col justify-center items-center w-full">
            <div class="gap-2 text-left m-5 w-[85%] flex flex-col">
                <label class="text-xl text-[#116089] font-semibold" for="number">NDIS Number <span class="text-error">*</span></label>
            ...
            <div class="gap-2 text-left m-5 w-[85%] flex flex-col">
                <label class="text-xl text-[#116089] font-semibold" for="startdate">Start Date <span class="text-error">*</span></label>
                <input bind:value={formData.ndis.startDate} class="input validator" type="date" id="startdate" name="startdate" required />
            </div>
            <div class="gap-2 text-left m-5 w-[85%] flex flex-col">
                <label class="text-xl text-[#116089] font-semibold" for="enddate">End Date <span class="text-error">*</span></label>
        ...
        <div id="review" class="flex flex-col justify-between items-start">
            <div class="m-2">
                ...
                <h3 class="text-md"><span class="text-[#116089] font-semibold">Date of Birth:</span> {formatDate(formData.participant.dob)}</h3>
            ...
            <div class="m-2">
                ...
                <h3 class="text-md"><span class="text-[#116089] font-semibold">Start Date:</span> {formatDate(formData.ndis.startDate)}</h3>
                <h3 class="text-md"><span class="text-[#116089] font-semibold">End Date:</span> {formatDate(formData.ndis.endDate)}</h3>
            </div>
            <div class="m-2">
